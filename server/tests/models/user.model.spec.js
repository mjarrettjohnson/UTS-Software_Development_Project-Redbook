...
describe('Model: User', () => {
  ...
  describe('#update password', () => {
    it('should update user password if original password matches', async () => {
      const result = await savedUser.updatePassword('thisisapassword2', 'thisisapassword1');
    ...
    it('should return an error if the original password does not match', async () => {
      const result = await savedUser.updatePassword('incorrectPassword', 'thisisanewpassword');
